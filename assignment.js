...
console.log("-------------------------------------------");
console.log("Q:11");
let friend = ["hassan", "shaheer", "usman", "ahmer"];
...
console.log("-------------------------------------------");
console.log("Q:12");
let friend1 = ["hassan", "shaheer", "usman", "ahmer"];
...
console.log("-------------------------------------------");
console.log("Q:13");
let transport = ["Motorcycle", "cycle", "car", "Helicopter"];
...
console.log("-------------------------------------------");
console.log("Q:14");
let invite = ["hassan", "shaheer", "ahmer", "ahsan"];
...
console.log("-------------------------------------------");
console.log("Q:15");
let invite1 = ["hassan", "shaheer", "ahmer", "ahsan"];
...
console.log("-------------------------------------------");
console.log("Q:16");
let invite2 = ["hassan", "shaheer", "ahmer", "ahsan"];
// let absent_guest = "ahsan";
// let new_guest = "Ali";
// invite1[3] = new_guest;
...
console.log("-------------------------------------------");
console.log("Q:17");
let invite3 = ["hassan", "shaheer", "ahmer", "ahsan"];
// let absent_guest = "ahsan";
// let new_guest = "Ali";
// invite1[3] = new_guest;
...
console.log("-------------------------------------------");
console.log("Q:18");
let place = ["Paris", "Tokyo", "New York", "Machu Picchu", "Sydney"];
...
console.log("-------------------------------------------");
console.log("Q:19");
let invite4 = ["hassan", "shaheer", "ahmer", "ahsan"];
...
console.log("-------------------------------------------");
console.log("Q:20");
let mountainsList = ["Mount Everest", "K2", "Denali", "Kangchenjunga", "Matterhorn"];
...
console.log("-------------------------------------------");
console.log("Q:30");
let username = ["admin", "hassan", "shaheer", "ahmer"];
...
console.log("-------------------------------------------");
console.log("Q:32");
let current_users = ["anas", "shaheer", "hassan", "ahsan", "ali"];
let new_name = ["admin", "hassan", "shaheer", "ahmer", "Ali"];
...
console.log("-------------------------------------------");
console.log("Q:34");
let pizzaNames = ["Pepperoni", "Margherita", "Supreme"];
...
console.log("-------------------------------------------");
console.log("Q:36");
function make_shirt(size, massag) {
...
console.log("-------------------------------------------");
console.log("Q:37");
function make_shirt1(size1 = "large", massa = "i love typescript") {
...
let location3 = city_country("newyork", "usa");
let location1 = city_country("mumbai", "india");
let location2 = city_country("melbourne", "australia");
...
console.log("-------------------------------------------");
console.log("Q:41");
let magicianName = ["Merlin", "Houdini", "Gandalf", "David Copperfield"];
...
let magicianNames1 = ["Merlin", "Houdini", "Gandalf", "David Copperfield"];
let greatMagicians1 = make_great(magicianNames1);
...
function createCar(manufacturer, model, extras) {
    const car = { manufacturer, model, extras };
    return car;
}
